...
def main() -> int:
    ...
    assignments: dict[str, list[str]] = {
        "MMA": ["にーずほっぐ（MMA）", "ふぇんりる（MMA）", "かみなり（MMA）", "どらうぐる（MMA）", "おばけ（MMA）"],
        "アラバスタ王国": ["海ネコ", "クンフージュゴン", "ワルサギ", "サンドラ大トカゲ", "ハサミ", "サンドラマレナマズ"],
        "ウォーターセブン": ["ヤガラ", "ヨコヅナ"],
        "エッグヘッド": ["メカシャーク", "ベガフォース01", "リサイクルワン"],
        "エニエス・ロビー": ["スズメ"],
        "エルバフ": ["蜜蜂兵", "針神様", "イスカット", "ヒルムンガルド", "ムギン", "グルトバニー（耳神様）", "パイパー", "ビブロ", "グロッキーザウルス", "アスラ"],
        "擬人化": [
            "和道一文字（刀擬人化）",
            "三代鬼徹（刀擬人化）",
            "秋水（刀擬人化）",
