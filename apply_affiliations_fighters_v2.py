...
def main() -> int:
    ...
    assignments: dict[str, list[str]] = {
        "温泉島": ["ゲダツ"],
        "ガレーラカンパニー": ["ダゴ", "オットランド", "フットビヤンコ"],
        "ケンタウロス巡回部隊": ["チャドロス・ヒゲリゲス（茶ひげ）"],
        "コーヒーモンキーズ": ["コーヒーモンキーズ"],
        "ココヤシ村": ["ベルメール"],
        "シモツキ村": ["霜月フリコ", "ロロノア・ピンゾロ", "ロロノア・アラシ", "テラ"],
        "シャボンディ諸島": ["シルバーズ・レイリー"],
        "ジャヤ": ["ジョボ"],
        "シャンディア": ["ヨツバネ", "マユシカ", "ワラシ", "シャンディアの酋長", "カルガラ", "チヤ", "セト", "コバーン"],
        "賞金稼ぎ": ["ジャン・アンゴ"],
        "スカイピア": [
            "ガン・フォール",
            "ピエール",
        ...
        "タコヤキ8": ["はっちゃん"],
        "ダダン一家": ["カーリー・ダダン", "ドグラ", "マグラ"],
        "テーナ・ゲーナ王国": ["サンクリン"],
        "ドレスローザ王国": ["キュロス（片足の兵隊）", "スパルタン", "ウーシー", "マミー", "メドウズ", "アギョウ", "ダマスク", "アキリア"],
        "トンタッタ王国": ["ランポー", "ペリーニ", "ヌーボン", "ボボンバ", "コットン", "ダイコン", "マウジイ"],
        "ニューカマーランド": ["ベンサム（Mr.2・ボン・クレー）", "ティバニー", "フランソワ", "ツノッコフ", "ウサッコフ"],
        "ハウンドペッツ": ["ピーターマン"],
        "パンクハザード": ["鉄筋のスムージ", "瓢箪 フェン・ボック", "縄引きのチャッペ", "マチェーテのルン"],
        "ヒグマ山賊団": ["ヒグマ"],
        "ヒョウ五郎一家": ["ヒョウ五郎"],
        "双子岬": ["クロッカス"],
        "フランキー一家": ["ザンバイ", "ショルゾウ", "コップ", "タマゴン", "キエフ", "キウイ", "モズ", "ソドム", "ゴモラ", "ダゴ", "オットランド", "フットビヤンコ"],
    }
