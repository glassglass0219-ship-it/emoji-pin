#!/usr/bin/env python3
"""1143〜1145話の登場を characters.json に反映（通常は appearances、扉絵は covers）。"""
    ...
    for ep_num in sorted(data_to_process.keys()):
        ...
        for list_name in info["normal"]:
            ...
            if target is not None:
                ...
                print(f"✨ 新規登録: {storage_name(list_name)} (id={next_id}, ep={ep_num}, appearances)")
                next_id += 1
                new_n += 1
        ...
        for list_name in info["cover"]:
            ...
            if target is not None:
                ...
                print(f"✨ 新規登録: {storage_name(list_name)} (id={next_id}, ep={ep_num}, covers)")
                next_id += 1
                new_n += 1
