...
def main() -> int:
    ...
    assignments: dict[str, list[str]] = {
        "オレンジの町": ["シュシュ", "ブードル", "ホッカー", "ポロ"],
        "キューカ島": ["サムライ・バッツ"],
        "ゴア王国": ["アウトルック3世", "ディディット", "アッホ・デスネン9世", "アッホ・ヅラコ"],
        "ココヤシ村": ["ノジコ", "ゲンゾウ", "Dr.ナコー", "ダディーディー", "マミーミー"],
        "ゴサの町": ["チャボ"],
        "ゴッドバレー": ["マグノリア"],
        "サクラ王国": ["ネギ熊まりあ", "タマチビ", "くれは", "イッシー100（イッシー20）"],
        "シェルズタウン": ["リカ", "リリカ"],
        "シモツキ村": ["くいな", "コウシロウ", "霜月コウ三郎"],
        "シャボンディ諸島": [
            "アントニオ",
            "シャクヤク（シャッキー）",
            "マリィ",
