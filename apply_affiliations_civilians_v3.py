...
def main() -> int:
    ...
    assignments: dict[str, list[str]] = {
        "ジャヤ": ["スペクトルさん", "テリー"],
        "シャンディア": ["イーサ", "ムース", "ハーブ"],
        "シロップ村": ["モーニン", "にんじん", "ピーマン", "たまねぎ", "カヤ", "門番", "メリー", "バンキーナ"],
        "スカイピア": ["アマゾン", "スー", "パガヤ", "アイサ", "賢者ゴーデ", "モイル", "モチ", "マリリン"],
        "砂砂団": ["コーザ", "おかめ", "ナットー", "ケビ"],
        "スフィンクス": ["オイデー"],
        "世界経済新聞社": ["アタッチ", "モルガンズ", "イヤンエーノウ・チノデ"],
        "ソルベ王国": ["クラップ"],
        "珍獣島": ["サーファンクル"],
        "トムズワーカーズ": ["ココロ", "アイスバーグ", "トム"],
        "トリノ王国": ["シャンバ"],
        # ドレスローザ王国: 今回リストにキャラ無し
        "トンタッタ王国": [
            "マリオ",
            "ギャッツ",
            "アレモ・ガンミー",
