#!/usr/bin/env python3
"""1179〜1181話の登場を characters.json に反映（通常は appearances、扉紙は covers）。"""
...
SYNONYMS: dict[str, str] = {
    ...
    "ネフェルタリ・ヴィヴィ": "ネフェルタリ・ビビ",
    "ネフェルタリ_ビビ": "ネフェルタリ・ビビ",
    "ネフェルタリ・D・リリ": "ネフェルタリ・D・リリィ",
    "白星": "しらほし",
    "黒隅玉": "お玉",
}
